...
const UserProfile = () => {
    ...
    return (
        <div style={{ minHeight: '100vh', background: 'var(--bg-dark)', color: 'var(--text-main)', padding: '2rem' }}>
            {/* Header */}
                    ...
                    {apps.length === 0 ? (
                        ...
                        <div style={{ display: 'grid', gap: '1rem' }}>
                            {apps.map((appItem, idx) => (
                                <div key={idx} style={{ padding: '1rem', background: 'var(--bg-hover)', borderRadius: '8px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                                    <div>
